...
class FakeAuthRepository implements AuthRepository {
  ...
  @override
  Future<UserProfile> createGuestUser({String? name}) async => UserProfile(
        id: 'test_user_1',
...
void main() {
  ...
  group('RoomNotifier & Voice Decoupling Tests', () {
    ...
    test('entering room in solo mode sets isSoloMode and voice is NOT joined', () async {
